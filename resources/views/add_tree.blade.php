...
<div class="card shadow">
    <div class="card-body">
        <h3 class="card-title text-center">Ajouter un nouvel arbre</h3>
        <div class="card-text mt-5">
            ...
            <div>
                <div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label">Nom de l'arbre</label>
                    <div class="col-sm-10 col-md-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa fa-tree"></i></span>
                            <input id="name" name="name" placeholder="Nom de l'arbre" type="text" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="root" class="col-sm-2 col-form-label">Première racine</label>
                    <div class="col-sm-10 col-md-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa fa-first-order"></i></i></span>
                            <input id="root" name="root" placeholder="Première racine" type="text" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="offset-2 col-4">
                        <button type="button" id="add_tree" class="btn btn-primary">Ajouter</button>
                    </div>
                </div>
            </div>

            <!-- <div class="mt-5" id="tree_roots"> -->
            <div class="mt-5" id="tree_roots" style="display:none">
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result['result'] == 1) {
                    ...
                    list_node.push('0-0-0-0');
                    $('#roots').append('<option value="0-0-0-0" id="0-0-0-0">' + $('#root').val() + '</option>');
                } else {
